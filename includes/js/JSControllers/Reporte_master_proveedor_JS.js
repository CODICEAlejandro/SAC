...
function retrieveABill(){
	...
	$.ajax({
		url: baseURL+"index.php/Reporte_master_proveedor_ctrl/getABillAJAX",
		data: {'folio': folio},
		dataType: 'json',
		method: 'post',
		beforeSend: function(){
...
function retrieveData(){
	...
	$.ajax({
		url: baseURL+"index.php/Reporte_master_proveedor_ctrl/getContentAJAX",
...
function saveNote(idConceptoCotizacion, nota){
	...
	$.ajax({
		url: baseURL+'index.php/Reporte_master_proveedor_ctrl/saveNote',
		method: 'post',
...
function saveEstadoFactura(idConceptoCotizacion, idEstadoFactura){
	...
	// $.ajax({
	// 	url: baseURL+'index.php/Reporte_master_proveedor_ctrl/saveEstadoFactura',
	// 	method: 'post',
...
function saveFechaPago(idConceptoCotizacion, fechaPago){
	...
	$.ajax({
		url: baseURL+'index.php/Reporte_master_proveedor_ctrl/saveFechaPago',
		method: 'post',
...
function retrieveRazonesSociales(){
	...
	$.ajax({
		url: baseURL+'index.php/Reporte_master_proveedor_ctrl/getRazonesSociales/',
		dataType: 'json',
		data: {"idCliente" : id},
		method: 'post',
		success: function(response){
...
function retrieveCotizaciones(){
	...
	$.ajax({
		url: baseURL+'index.php/Reporte_master_proveedor_ctrl/getCotizaciones/',
		dataType: 'json',
...
function retrieveEstadosFactura(){
	$.ajax({
		url: baseURL+'index.php/Reporte_master_proveedor_ctrl/getEstadosFactura/',
		dataType: 'json',
		method: 'post',
		success: function(response){
