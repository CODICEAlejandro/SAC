		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="list-group">
					...
					<a class="btn list-group-item" href="<?php echo base_url().'index.php/Reporte_porcentaje_cumplimiento_ctrl'; ?>" style="text-align: left;">Reporte de porcentaje de cumplimiento</a>
